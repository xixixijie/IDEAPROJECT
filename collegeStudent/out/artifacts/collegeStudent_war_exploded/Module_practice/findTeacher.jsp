...
<head>
    ...
    <link rel="stylesheet" href="../css/findTeacher.css" type="text/css"/>
    <script language="JavaScript">
        function signCheck() {
            if (form1.id.value == "") {
                ...
                form1.action = "../userServlet?action=login&url=Module_practice/findTeacher.jsp";
                form1.submit();
            }
        }
        function logout(){
            javascipt:location.href='../userServlet?action=logout&url=Module_practice/findTeacher.jsp';
        }
    </script>
</head>
<body>
<div id="container">
    ...
    <div id="signIn" >
        ...
        <br/>
        <div id="main_body">
            <a class="button1" href="studentPublish.jsp"></a>
            <a class="button2" href="../stuServlet?action=search"></a>
        </div>
    </div>
</div>
</body>
