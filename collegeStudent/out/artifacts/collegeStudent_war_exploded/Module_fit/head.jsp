    ...
    <script language="JavaScript">
        function signCheck() {
            if (form1.id.value == "") {
                ...
                form1.action = "../userServlet?action=login&url=Module_fit/head.jsp";
                form1.submit();
            }
        }
        function logout(){
            javascipt:location.href='../userServlet?action=logout&url=Module_fit/head.jsp';
        }
    </script>
</head>
<body>
...
<div id="nav">
    <ul>
        ...
        <li><span><a target="_top" href="fit.jsp">体育健身</a></span></li>
