...
<head>
    ...
    form1.action = "../userServlet?action=login&url=Module_resource/head.jsp";
    form1.submit();
    }
    }
    function logout(){
        javascipt:location.href='../userServlet?action=logout&url=Module_resource/head.jsp';
    }
    </script>
</head>
<body>
...
<div id="nav">
        ...
        <ul>
            ...
            <li><span><a target="_top" href="resource.jsp">资源发布</a></span></li>
